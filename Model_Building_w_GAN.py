...
print('Accuracy is:', round(ab_acc *100,4))
    
acc_table = acc_table.append({'Name':"AdaBoost",'Accruacy Rate':ab_acc }, 
                                 ignore_index = True)
...
acc_table.iloc[1:6,1] = acc_table.iloc[1:6,2]

acc_table = acc_table.iloc[:,0:2]
